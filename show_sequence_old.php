...
<!--pattern viewer -->        
	...
	<div id = "pattern_title" class = "container4" ><b>Pattern Viewer</b></div>
	<fieldset style=" padding:none;">
                    <legend><span class="h3_italic"></span></legend>
	<div class = "seq_viewer_area" id="seq_viewer_area">
        	...
        	<table style="width:900px;margin-top:10px;margin-bottom:10px;">
                    <?php
                    echo "<tr>";
                    ...
                    <input type = "text" id = "user_pattern_area" style="margin-top:10px;margin-bottom:10px;"></input>
                        <legend>
                                    ...
                                    &nbsp;&nbsp;
                                    <span style="text-align:center;"><font size="2" color='red'><strong><u>N</u></strong></font></span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                        </legend>
<!--                            <legend>
                    ...
                    <div id = "seq_content_area" style="max-height:400px;overflow:auto;margin-top:20px;">
...
<!--            sequence viewer-->
	...
	<div id = "gene_title" class = "container4" ><b>Gene Viewer</b></div>
	<fieldset style=" padding:none;">
                    <legend><span class="h3_italic"></span></legend>
...
<!--                            <legend>
                    ...
                    <div id = "seq_content" style="max-height:400px;overflow:auto;margin-top:20px;">
                            <p class = "sequence" id = "sequence"style="word-break:break-all;"><?php echo "AATAAAAAA";  ?>
                            </p>	            	
                    </div>
	</div>
