	...
	<div class="main">
                    <div class="page_container">
                      ...
                      <div class="jumpto-block">
                        ...
                        <p>Fuzzy search, is also permitted, which allows user to search various database entries by a single keyword. <span class="pic_red">(Fig. 12)</span>
                    ...
                    <div class="jumpto-block">
                        ...
                        The main output is a table that lists all resulted PACs.<span class="pic_red">(Fig. 27)</span> 
                        ...
                        The main output is a table that lists all resulted genes and PACs.<span class="pic_red">(Fig. 29)</span> 
