            <?php
                ...
                if($_POST['est_sequence_text']!=''){
                    mkdir("./result/".$_SESSION['file']."/");
                    chmod("./result/".$_SESSION['file']."/", 0777);
                    mkdir("./data/".$_SESSION['file']."/");
                    chmod("./data/".$_SESSION['file']."/", 0777);
                    $textfile=$_POST['est_text_name'].".fa";
                    file_put_contents($filepath.$textfile, $_POST['est_sequence_text']);
                    $usr_group = array();
                    array_push($usr_group, $_POST['est_text_group']);
...
//                echo"<pre>$out10</pre>";
            ...
            foreach ($upload_name as $key => $value) {
                 ...
                 shell_exec("./src/c/jq '(.tracks) |= . + [{\"storeClass\" : \"JBrowse/Store/SeqFeature/BigWig\",\"urlTemplate\" : \"'$value'.UsrPosPA.bw\",\"type\" : \"JBrowse/View/Track/Wiggle/XYPlot\",\"label\" : \"'$value' PAT  plus strand\",\"key\" : \"'$value' PAT  plus strand\",\"category\": \"trap results\",\"autoscale\" : \"local\",\"style\" : {\"neg_color\" : \"red\",\"pos_color\" : \"blue\"},\"variance_ban\" : false}]' /var/www/jbrowse/data/".$_SESSION['file']."/trackList.json > /var/www/jbrowse/data/".$_SESSION['file']."/trackList1.json 2>./tojbrowse/haha.tct");
                 shell_exec("./src/c/jq '(.tracks) |= . + [{\"storeClass\" : \"JBrowse/Store/SeqFeature/BigWig\",\"urlTemplate\" : \"'$value'.UsrNegPA.bw\",\"type\" : \"JBrowse/View/Track/Wiggle/XYPlot\",\"label\" : \"'$value' PAT  minus strand\",\"key\" : \"'$value' PAT  minus strand\",\"category\": \"trap results\",\"autoscale\" : \"local\",\"style\" : {\"neg_color\" : \"blue\",\"pos_color\" : \"red\"},\"variance_ban\" : false}]' /var/www/jbrowse/data/".$_SESSION['file']."/trackList1.json > /var/www/jbrowse/data/".$_SESSION['file']."/trackList2.json 2>./tojbrowse/haha.tct");
