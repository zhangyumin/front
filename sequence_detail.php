...
//                                                        var_dump($type);
                ...
                <div id="newwindow" style="float:right;display: inline-block;font-weight: bold;background-color: #5db95b;font-size: 22px"><a href="./display.php?species=<?php echo $species;?>&seq=<?php echo $seq ?>" title="view in a new window"><img src="pic/newwindow.png" style="width:20px;padding:11px 10px 0px 10px;height:20px"></a>
                <tr>
