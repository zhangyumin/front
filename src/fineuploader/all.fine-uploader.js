...
!function () {
	...
	qq.dataUriToBlob = function (a) {
		...
		e = a.split(",")[0].split(":")[1].split(";")[0],
		b = new ArrayBuffer(c.length),
		d = new Uint8Array(b),
		qq.each(c, function (a, b) {
			d[a] = b.charCodeAt(0)
		}),
		f(b, e)
	},
...
(), qq.version = "5.2.2", qq.supportedFeatures = function () {
	...
	x;
	return j = a(),
	m = j && qq.isXhrUploadSupported(),
	k = m && !qq.androidStock(),
	l = m && i(),
	n = l && b(),
	o = m && qq.isFileChunkingSupported(),
	p = m && o && h(),
	q = m && c(),
	r = j && (void 0 !== window.postMessage || m),
	t = d(),
	s = e(),
	u = f(),
	v = g(),
	w = m && void 0 !== window.FileReader,
	x = function () {
...
(), qq.isGenericPromise = function (a) {
	...
	qq.extend(this, {
		addFile : function (b) {
			...
			return b.batchId && (e[d].batchId = b.batchId, void 0 === i[b.batchId] && (i[b.batchId] = []), i[b.batchId].push(d)),
			b.proxyGroupId && (e[d].proxyGroupId = b.proxyGroupId, void 0 === h[b.proxyGroupId] && (h[b.proxyGroupId] = []), h[b.proxyGroupId].push(d)),
			e[d].id = d,
			f[b.uuid] = d,
			void 0 === g[c] && (g[c] = []),
			g[c].push(d),
			a.onStatusChange(d, null, c),
			d
		},
		retrieve : function (a) {
	...
	qq.basePublicApi = {
		...
		addFiles : function (a, b, c) {
			...
			j = function () {
				qq.isFileList(a) && (a = Array.prototype.slice.call(a)),
				a = [].concat(a)
			},
			k = this,
			l = [];
			this._currentBatchId = d,
			a && (j(), qq.each(a, function (a, b) {
		...
		getParentId : function (a) {
			...
			c = null;
			return b && void 0 !== b.parentId && (c = b.parentId),
			c
		},
	...
	qq.basePrivateApi = {
		...
		_createUploadDataTracker : function () {
			...
			return new qq.UploadData({
				...
				onStatusChange : function (b, c, d) {
					...
					a._maybeAllComplete(b, d),
					a._totalProgress && setTimeout(function () {
		...
		_createUploadHandler : function (a, b) {
			...
			e.customHeaders = this._customHeadersStore,
		...
		_handleNewFile : function (a, b, c) {
			...
			!qq.isInput(h) && h.size >= 0 && (f = h.size),
			i(h, g, e, f, c, b, this._options.request.uuidName, {
				uploadData : d._uploadData,
				paramsStore : d._paramsStore,
				addFileToHandler : function (a, b) {
					d._handler.add(a, b),
					d._netUploadedOrQueued++,
					d._trackButton(a)
				}
			})
		},
		...
		_onAllComplete : function (a, b) {
			...
			this._options.callbacks.onAllComplete(qq.extend([], a), qq.extend([], b)),
			this._succeededSinceLastAllComplete = [],
			this._failedSinceLastAllComplete = []
		},
		_onAutoRetry : function (a, b, c, d, e) {
			...
			f._shouldAutoRetry(a, b, c) ? (f._maybeParseAndSendUploadError.apply(f, arguments), f._options.callbacks.onAutoRetry(a, b, f._autoRetries[a]), f._onBeforeAutoRetry(a, b), f._retryTimeouts[a] = setTimeout(function () {
						f.log("Retrying " + b + "..."),
		...
		_onComplete : function (a, b, c, d) {
			return c.success ? (c.thumbnailUrl && (this._thumbnailUrls[a] = c.thumbnailUrl), this._netUploaded++, this._uploadData.setStatus(a, qq.status.UPLOAD_SUCCESSFUL)) : (this._netUploadedOrQueued--, this._uploadData.setStatus(a, qq.status.UPLOAD_FAILED), c[this._options.retry.preventRetryResponseProperty] === !0 && (this._preventRetries[a] = !0)),
		...
		_onValidateCallbackFailure : function (a, b, c, d) {
			var e = b + 1;
			this._fileOrBlobRejected(a[b].id, a[b].file.name),
		...
		_setSize : function (a, b) {
			this._uploadData.updateSize(a, b),
			this._totalProgress && this._totalProgress.onNewSize(a)
		},
...
(), qq.AjaxRequester = function (a) {
	...
	function e() {
		var a;
		return (window.XMLHttpRequest || window.ActiveXObject) && (a = qq.createXhrInstance(), void 0 === a.withCredentials && (a = new XDomainRequest)),
		a
	}
	function f(a, b) {
		var c = v[a].xhr;
	...
	function h(a, b) {
		...
		h = b === !0;
		g(a),
		h ? s(e + " request for " + a + " has failed", "error") : d(c) || q(c.status) || (h = !0, s(e + " request for " + a + " has failed - response code " + c.status, "error")),
		w.onComplete(a, c, h)
	}
	function i(a) {
		var b,
		...
		d = w.mandatedParams;
		return w.paramsStore.get && (b = w.paramsStore.get(a)),
	...
	function j(a, b) {
		...
		return w.onSend(a),
		c = k(a, h),
		d(e) ? (e.onload = n(a), e.onerror = o(a)) : e.onreadystatechange = l(a),
		m(a),
		e.open(g, c, !0),
		w.cors.expected && w.cors.sendCredentials && !d(e) && (e.withCredentials = !0),
		p(a),
		s("Sending " + g + " request for " + a),
		j ? e.send(j) : t || !h ? e.send() : h && w.contentType && w.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? e.send(qq.obj2url(h, "")) : h && w.contentType && w.contentType.toLowerCase().indexOf("application/json") >= 0 ? e.send(JSON.stringify(h)) : e.send(h),
		e
	}
	function k(a, b) {
	...
	t = "GET" === w.method || "DELETE" === w.method,
	qq.extend(this, {
	...
	qq.extend(this, {
		...
		cancel : function (a) {
			...
			g = d(a, e(a), f);
			g.then(function () {
				b.isValid(a) && (c[a].canceled = !0, b.expunge(a)),
				f.success()
			})
		},
		expunge : function (a) {
	...
	j = {
			...
			e._getFileState(a).attemptingResume = !1,
			delete e._getFileState(a).temp.chunkProgress[b],
			e._getFileState(a).loaded += f.size,
			i.onUploadChunkSuccess(a, e._getChunkDataForCallback(f), c, d)
		},
		finalize : function (a) {
			var b = i.getSize(a),
			c = i.getName(a);
			d("All chunks have been uploaded for " + a + " - finalizing...."),
			e.finalizeChunks(a).then(function (f, g) {
				d("Finalize successful for " + a);
				var h = m.normalizeResponse(f, !0);
				i.onProgress(a, c, b, b),
				e._maybeDeletePersistedChunkData(a),
				m.cleanup(a, h, g)
			}, function (b, e) {
				var f = m.normalizeResponse(b, !1);
				d("Problem finalizing chunks for file ID " + a + " - " + f.error, "error"),
				f.reset && j.reset(a),
		...
		sendNext : function (a) {
			...
			null == e._getFileState(a).loaded && (e._getFileState(a).loaded = 0),
			l && i.onResume(a, c, g) === !1 && (j.reset(a), f = j.nextPart(a), g = e._getChunkData(a, f), l = !1),
			null == f && 0 === n.length ? j.finalize(a) : (d("Sending chunked upload request for item " + a + ": bytes " + (g.start + 1) + "-" + g.end + " of " + b), i.onUploadChunk(a, c, e._getChunkDataForCallback(g)), n.push(f), e._getFileState(a).chunking.inProgress = n, h && k.open(a, f), h && k.available() && e._getFileState(a).chunking.remaining.length && j.sendNext(a), e.uploadChunk(a, f, l).then(function (b, c) {
					d("Chunked upload request succeeded for " + a + ", chunk " + f),
					e.clearCachedChunk(a, f);
					var g = e._getFileState(a).chunking.inProgress || [],
					h = m.normalizeResponse(b, !0),
					i = qq.indexOf(g, f);
					d(qq.format("Chunk {} for file {} uploaded successfully.", f, a)),
					j.done(a, f, h, c),
					i >= 0 && g.splice(i, 1),
					e._maybePersistChunkedState(a),
					j.hasMoreParts(a) || 0 !== g.length ? j.hasMoreParts(a) && j.sendNext(a) : j.finalize(a)
				}, function (b, g) {
					d("Chunked upload request failed for " + a + ", chunk " + f),
					e.clearCachedChunk(a, f);
					var l,
					n = m.normalizeResponse(b, !1);
					n.reset ? j.reset(a) : (l = qq.indexOf(e._getFileState(a).chunking.inProgress, f), l >= 0 && (e._getFileState(a).chunking.inProgress.splice(l, 1), e._getFileState(a).chunking.remaining.unshift(f))),
	...
	k = {
		...
		free : function (a, b) {
			...
			delete k._openChunks[a],
			m.getProxyOrBlob(a)instanceof qq.BlobProxy && (d("Generated blob upload has ended for " + a + ", disposing generated blob."), delete e._getFileState(a).file),
			g >= 0 ? k._waiting.splice(g, 1) : f && h >= 0 && (k._open.splice(h, 1), c = k._waiting.shift(), c >= 0 && (k._open.push(c), m.start(c)))
		},
		...
		open : function (a, b) {
			return null == b && k._waiting.push(a),
			k.available() ? (null == b ? (k._waiting.pop(), k._open.push(a)) : function () {
	...
	l = {
		send : function (a, b) {
			e._getFileState(a).loaded = 0,
			d("Sending simple upload request for " + a),
			e.uploadFile(a).then(function (c, e) {
				d("Simple upload request succeeded for " + a);
				var f = m.normalizeResponse(c, !0),
				g = i.getSize(a);
				i.onProgress(a, b, g, g),
				m.maybeNewUuid(a, f),
				m.cleanup(a, f, e)
			}, function (c, e) {
	...
	m = {
		cancel : function (a) {
			d("Cancelling " + a),
			i.paramsStore.remove(a),
			k.free(a)
		},
		cleanup : function (a, b, c) {
			var d = i.getName(a);
			i.onComplete(a, d, b, c),
			e._getFileState(a) && e._clearXhrs && e._clearXhrs(a),
			k.free(a)
		},
		...
		maybeDefer : function (a, b) {
			return b && !e.getFile(a) && b instanceof qq.BlobProxy ? (i.onUploadPrep(a), d("Attempting to generate a blob on-demand for " + a), b.create().then(function (b) {
					d("Generated an on-demand blob for " + a),
					e.updateBlob(a, b),
					i.setSize(a, b.size),
					e.reevaluateChunking(a),
					...
					var e = {};
					b && (e.error = b),
					d(qq.format("Failed to generate blob for ID {}.  Error message: {}.", a, b), "error"),
					i.onComplete(a, i.getName(a), qq.extend(e, c), null),
					m.maybeSendDeferredFiles(a),
					k.free(a)
		...
		normalizeResponse : function (a, b) {
			var c = a;
			return qq.isObject(a) || (c = {}, qq.isString(a) && !b && (c.error = a)),
			c.success = b,
			c
		},
		now : function (a) {
			...
			i.onUpload(a, b),
			g && e._shouldChunkThisFile(a) ? j.sendNext(a) : l.send(a, b)
		},
		start : function (a) {
	...
	qq.extend(this, {
		...
		retry : function (a) {
			return h && (e._getFileState(a).temp.ignoreFailure = !1),
			k.isUsingConnection(a) ? m.start(a) : f.upload(a)
		},
		cancel : function (a) {
			var b = e.cancel(a);
	...
	qq.extend(i, a),
	d = i.log,
	g = i.chunking.enabled && qq.supportedFeatures.chunking,
	h = g && i.chunking.concurrent.enabled,
	c = function () {
		var a = {};
		return a[i.preventRetryParam] = !0,
		a
	}
	(),
	m.initHandler()
	...
	function b(a) {
		delete k[a],
		m && (clearTimeout(l[a]), delete l[a], q.stopReceivingMessages(a));
	...
	qq.extend(this, new qq.UploadHandler(a)),
	...
	function b(a) {
		qq.each(c._getXhrs(a), function (b, d) {
			...
			d.upload.onprogress = null,
			d.abort(),
			e && e.canceled && e.canceled(a)
		})
	}
	var c = this,
	...
	qq.override(this, function (a) {
		return {
			add : function (b, d) {
				...
				c._initTempState(b),
				i && c._maybePrepareForResume(b)
			},
			expunge : function (d) {
				b(d),
				c._maybeDeletePersistedChunkData(d),
				c._clearXhrs(d),
				a.expunge(d)
			}
		}
	...
	qq.extend(this, {
		...
		clearXhr : function (a, b) {
			...
			d.xhrs && delete d.xhrs[b],
			d.ajaxRequesters && delete d.ajaxRequesters[b]
		},
		...
		_registerXhr : function (a, b, d, e) {
			...
			return g.xhrs = g.xhrs || {},
			g.ajaxRequesters = g.ajaxRequesters || {},
			g.xhrs[f] = d,
			e && (g.ajaxRequesters[f] = e),
			d
		},
		_removeExpiredChunkingRecords : function () {
			...
			c._iterateResumeRecords(function (b, c) {
				...
				d.getTime() <= Date.now() && (q("Removing expired resume record with key " + b), localStorage.removeItem(b))
			})
		},
		_shouldChunkThisFile : function (a) {
			var b = c._getFileState(a);
			return b.chunking || c.reevaluateChunking(a),
			b.chunking.enabled
		}
	})
	...
	qq.uiPublicApi = {
		...
		setName : function (a, b) {
			...
			this._templating.updateFilename(a, c)
		},
		pauseUpload : function (a) {
	...
	qq.uiPrivateApi = {
		...
		_filenameEditHandler : function () {
			...
			return {
				...
				onEditingStatusChange : function (a, c) {
					...
					c ? (d.addClass("qq-editing"), b.hideFilename(a), b.hideEditIcon(a)) : (d.removeClass("qq-editing"), b.showFilename(a), b.showEditIcon(a)),
		...
		_onUploadStatusChange : function (a, b, c) {
			...
			c === qq.status.UPLOAD_RETRYING ? (this._templating.setStatusText(a), qq(this._templating.getFileContainer(a)).removeClass(this._classes.retrying)) : c === qq.status.UPLOAD_FAILED && this._templating.hidePause(a)
		},
		...
		_onProgress : function (a, b, c, d) {
			...
			100 === Math.round(100 * (c / d)) ? (this._templating.hideCancel(a), this._templating.hidePause(a), this._templating.hideProgress(a), this._templating.setStatusText(a, this._options.text.waitingForResponse), this._displayFileSize(a)) : this._displayFileSize(a, c, d)
		},
		_onTotalProgress : function (a, b) {
			this._parent.prototype._onTotalProgress.apply(this, arguments),
			this._templating.updateTotalProgress(a, b)
		},
		...
		_onUploadChunk : function (a, b) {
			...
			b.partIndex > 0 && this._handler.isResumable(a) && this._templating.allowPause(a)
		},
		_onCancel : function (a) {
		...
		_onBeforeAutoRetry : function (a) {
			...
			this._options.retry.showAutoRetryNote && (b = this._autoRetries[a], c = this._options.retry.maxAutoAttempts, d = this._options.retry.autoRetryNote.replace(/\{retryNum\}/g, b), d = d.replace(/\{maxAuto\}/g, c), this._templating.setStatusText(a, d), qq(this._templating.getFileContainer(a)).addClass(this._classes.retrying))
		},
		_onBeforeManualRetry : function (a) {
		...
		_onDeleteComplete : function (a, b, c) {
			...
			this._templating.hideSpinner(a),
			c ? (this._templating.setStatusText(a, this._options.deleteFile.deletingFailedText), this._templating.showDeleteButton(a)) : this._removeFileItem(a)
		},
		...
		_formatProgress : function (a, b) {
			...
			return c("{percent}", Math.round(100 * (a / b))),
		...
		_controlFailureTextDisplay : function (a, b) {
			...
			d = this._options.failedUploadTextDisplay.responseProperty,
		...
		_setSize : function (a, b) {
			...
			this._templating.updateSize(a, this._formatSize(b))
		}
	}
}
(), qq.FineUploader = function (a, b) {
	...
	A = function () {
		...
		h && (a ? v.imageGenerator.generate(a, new Image, d).then(function (a) {
				...
				y.failure(),
				b("Problem loading 'not available' placeholder image at " + a, "error")
			}) : y.failure(), c ? v.imageGenerator.generate(c, new Image, d).then(function (a) {
				z.success(a)
			}, function () {
				z.failure(),
				b("Problem loading 'waiting for thumbnail' placeholder image at " + c, "error")
			}) : z.failure())
	},
	B = function (a) {
		...
		return z.then(function (c) {
			U(c, a),
			a.src ? b.success() : (a.src = c.src, a.onload = function () {
				a.onload = null,
				_(a),
				b.success()
			})
	...
	C = function (a, c, d) {
		var e = S(a);
		return b("Generating new thumbnail for " + a),
		c.qqThumbnailId = a,
		v.imageGenerator.generate(c, e, d).then(function () {
			r++,
			_(e),
			x[a].success()
		}, function () {
			x[a].failure(),
			v.placeholders.waitUntilUpdate || V(a, e)
		})
	},
	D = function () {
		if (t.length) {
	...
	W = function () {
		...
		s,
		t;
		if (b("Parsing template"), null == v.templateIdOrEl)
			throw new Error("You MUST specify either a template element or ID!");
		if (qq.isString(v.templateIdOrEl)) {
			if (a = document.getElementById(v.templateIdOrEl), null === a)
				throw new Error(qq.format("Cannot find template script at ID '{}'!", v.templateIdOrEl));
			e = a.innerHTML
		} else {
			if (void 0 === v.templateIdOrEl.innerHTML)
		...
		if (e = qq.trimStr(e), g = document.createElement("div"), g.appendChild(qq.toElement(e)), t = qq(g).getByClass(w.uploader)[0], v.button && (k = qq(g).getByClass(w.button)[0], k && qq(k).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (r = qq(g).getByClass(w.dropProcessing)[0], r && qq(r).remove()), p = qq(g).getByClass(w.drop)[0], p && !qq.DragAndDrop && (b("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop ? qq(t).hasAttribute(o) && p && (s = qq(p).getByClass(w.dropText)[0], s && qq(s).remove()) : (t.removeAttribute(o), p && qq(p).hasAttribute(n) && qq(p).css({
					display : "none"
				})), q = qq(g).getByClass(w.thumbnail)[0], h ? q && (u = parseInt(q.getAttribute(l)), u = u > 0 ? u : null, i = qq(q).hasAttribute(m)) : q && qq(q).remove(), h = h && q, c = qq(g).getByClass(w.editFilenameInput).length > 0, d = qq(g).getByClass(w.retry).length > 0, f = qq(g).getByClass(w.list)[0], null == f)
			throw new Error("Could not find the file list container in the template!");
		return j = f.innerHTML,
		f.innerHTML = "",
		g.getElementsByTagName("DIALOG").length && document.createElement("dialog"),
	...
	Z = function (a) {
		...
		if (e)
			if (c) {
				if (!(v.limits.maxThumbs && v.limits.maxThumbs <= r))
					return d && B(e), v.imageGenerator.generate(c, e, f).then(function () {
						_(e),
						r++,
						setTimeout(D, v.limits.timeBetweenThumbs)
					}, function () {
	...
	$ = function (a, b) {
		...
		c && !qq(c).hasClass(d) && (c = qq(c).getByClass(d)[0]),
		c && (qq(c).css({
				width : b + "%"
	...
	ab = function (a, c) {
		...
		x[c].then(function () {
			r++,
			x[a].success(),
			b(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", c, a)),
			d.src = e.src,
			_(d)
		}, function () {
			x[a].failure(),
			v.placeholders.waitUntilUpdate || V(a, d)
		})
	};
	qq.extend(v, a),
	b = v.log,
	qq.supportedFeatures.imagePreviews || (v.limits.timeBetweenThumbs = 0, v.limits.maxThumbs = 0),
	f = v.containerEl,
	h = void 0 !== v.imageGenerator,
	e = W(),
	A(),
	qq.extend(this, {
		render : function () {
			b("Rendering template in DOM."),
			r = 0,
			f.innerHTML = e.template,
			T(I()),
			this.hideTotalProgress(),
			g = v.fileContainerEl || R(f, w.list),
			b("Template rendering complete")
		},
		...
		addFile : function (a, b, c) {
			...
			qq(h).addClass(k + a),
			l.removeAttribute(o),
			i && (qq(i).setText(b), i.setAttribute("title", b)),
			h.setAttribute(j, a),
			c ? X(h, c.index) : g.appendChild(h),
			T(N(a)),
			T(P(a)),
			T(H(a)),
			T(O(a)),
			...
			q && this.hideCancel(a),
			d = S(a),
			d && !d.src && z.then(function (a) {
				d.src = a.src,
				a.style.maxHeight && a.style.maxWidth && qq(d).css({
		...
		uploadPaused : function (a) {
			this.setStatusText(a, v.text.paused),
		...
		showDialog : function (a, b, c) {
			...
			l = function () {
				d.removeEventListener("close", j),
				h.removeEventListener("click", l),
				d.close(),
				i.success(f && f.value)
			};
			return d.addEventListener("close", j),
	...
	function c(a, b) {
		...
		try {
			...
			f = d.body.innerHTML,
			h("converting iframe's innerHTML to JSON"),
			h("innerHTML = " + f),
			f && f.match(/^<pre/i) && (f = d.body.firstChild.firstChild.nodeValue),
			c = e._parseJsonResponse(f)
		} catch (g) {
			h("Error when attempting to parse form upload response (" + g.message + ")", "error"),
			c = {
				success : !1
			}
		}
	...
	function d(b, c) {
		...
		j = f(b);
		return d[a.uuidName] = g(b),
		d[a.filenameParam] = j,
		e._initFormForUpload({
			method : h,
			endpoint : i,
			params : d,
	...
	this.uploadFile = function (b) {
		...
		return f = d(b, i),
		f.appendChild(g),
		e._attachLoadEvent(i, function (d) {
			h("iframe loaded");
			var f = d ? d : c(b, i);
			e._detachLoadEvent(b),
			a.cors.expected || qq(i).remove(),
			f.success ? j.success(f) : j.failure(f)
		}),
		h("Sending upload request for " + b),
		f.submit(),
		qq(f).remove(),
		j
	},
	...
	i = function (b, c, f) {
		var g = e(b),
		i = d(b);
		c[a.chunking.paramNames.partIndex] = f.part,
		c[a.chunking.paramNames.partByteOffset] = f.start,
		c[a.chunking.paramNames.chunkSize] = f.size,
		c[a.chunking.paramNames.totalParts] = f.count,
		c[a.totalFileSizeName] = g,
		h && (c[a.filenameParam] = i)
	},
	...
	l = function (b) {
		...
		h = d(b),
		i = e(b);
		return g[a.uuidName] = f(b),
		g[a.filenameParam] = h,
		g[a.totalFileSizeName] = i,
		g[a.chunking.paramNames.totalParts] = c._getTotalChunks(b),
		g
	},
	m = function (a, b) {
	...
	n = function (a, b) {
		var c;
		return g("xhr - server response received for " + a),
	...
	q = function (b, c, g, i) {
		...
		m = d(i),
		n = e(i);
		return b[a.uuidName] = f(i),
		b[a.filenameParam] = m,
		h && (b[a.totalFileSizeName] = n),
		a.paramsInBody || (h || (b[a.inputName] = m), l = qq.obj2url(b, l)),
		c.open(k, l, !0),
		a.cors.expected && a.cors.sendCredentials && (c.withCredentials = !0),
		h ? (a.paramsInBody && qq.obj2FormData(b, j), j.append(a.inputName, g), j) : g
	},
	r = function (b, d) {
		...
		h || (d.setRequestHeader("Content-Type", "application/octet-stream"), d.setRequestHeader("X-Mime-Type", f.type)),
		qq.each(e, function (a, b) {
	...
	qq.extend(this, {
		uploadChunk : function (b, d, f) {
			...
			h,
			j,
			l = c._getChunkData(b, d),
			m = c._createXhr(b, d);
			return e(b),
			g = k(b, m),
			c._registerProgressHandler(b, d, l.size),
			j = a.paramsStore.get(b),
			i(b, j, l),
			f && (j[a.resume.paramNames.resuming] = !0),
			h = q(j, m, l.blob, b),
			r(b, m),
			m.send(h),
			g
		...
		uploadFile : function (b) {
			...
			g,
			h = c.getFile(b);
			return e = c._createXhr(b),
			c._registerProgressHandler(b),
			d = k(b, e),
			f = a.paramsStore.get(b),
			g = q(f, e, h, b),
			r(b, e),
			e.send(g),
			d
	...
	qq.extend(d, a),
	b = qq.extend(this, new qq.AjaxRequester({
				...
				onComplete : function (a, b, c) {
					var d = e[a];
					delete e[a],
					c ? d.failure(b) : d.success(b)
				}
			})),
	qq.extend(this, {
		complete : function (a, c, f, g) {
			var h = new qq.Promise;
			return d.log("Submitting All Chunks Done request for " + a),
			e[a] = h,
			b.initTransport(a).withParams(f).withHeaders(g).send(c),
			h
		}
	})
	...
	function b(a, b) {
		...
		j.callbacks.dropLog("Grabbed " + a.length + " dropped files."),
		b.dropDisabled(!1),
	...
	function e(a, b) {
		var d = [],
		e = new qq.Promise;
		return j.callbacks.processingDroppedFiles(),
		b.dropDisabled(!0),
		a.files.length > 1 && !j.allowMultipleItems ? (j.callbacks.processingDroppedFilesComplete([]), j.callbacks.dropError("tooManyFilesError", ""), b.dropDisabled(!1), e.failure()) : (n = [], qq.isFolderDropSupported(a) ? qq.each(a.items, function (a, b) {
				var f = b.webkitGetAsEntry();
				f && (f.isFile ? n.push(b.getAsFile()) : d.push(c(f).done(function () {
							d.pop(),
							0 === d.length && e.success()
						})))
			}) : n = a.files, 0 === d.length && e.success()),
		e
	}
	function f(a) {
		var c = new qq.UploadDropZone({
				...
				element : a,
				onEnter : function (b) {
					qq(a).addClass(j.classes.dropActive),
					b.stopPropagation()
				},
		...
		b = function () {
			setTimeout(function () {
				qq.each(a, function (a, b) {
					qq(b).hasAttribute(l) && qq(b).hide(),
					qq(b).removeClass(j.classes.dropActive)
				})
			}, 10)
		};
	...
	function d(a) {
		...
		c = a.dataTransfer,
		d = qq.safari();
		return b = qq.ie() && qq.supportedFeatures.fileDrop ? !0 : "none" !== c.effectAllowed,
	...
	qq.extend(d, a),
	c = qq.extend(this, new qq.AjaxRequester({
				acceptHeader : "application/json",
	...
	qq.extend(this, {
		sendDelete : function (a, b, e) {
			...
			"DELETE" === d.method ? c.initTransport(a).withPath(b).withParams(f).send() : (f[d.uuidParamName] = b, c.initTransport(a).withParams(f).send())
		}
	})
}, function () {
	function a(a) {
	...
	function e(c, e, g, h) {
		...
		n = e.getContext("2d");
		n.save(),
		qq.supportedFeatures.unlimitedScaledImageSize || (i = d({
					origWidth : l,
					origHeight : m
				}), i && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", l, m, i.newWidth, i.newHeight), "warn"), l = i.newWidth, m = i.newHeight)),
		f(e, l, m, g.orientation),
		qq.ios() ? function () {
			a(c) && (j /= 2, k /= 2);
			var d,
			e,
...
(), qq.ImageGenerator = function (a) {
	...
	function d(b, c) {
		var e = b,
		f = c;
		return void 0 === e && (e = 2, f = new qq.Promise),
	...
	function j(a, b) {
		...
		return qq.each(b, function (b, g) {
			...
			n = e.indexOf(m);
			return n >= 0 && (i = l[m].name, j = l[m].bytes, h = g.slice(d, d + 2 * j), f[i] = a ? c(h) : parseInt(h, 16), e.splice(n, 1)),
			0 === e.length ? !1 : void 0
		}),
		f
	}
	...
	qq.extend(this, {
		isPreviewable : function () {
			...
			b("First pass: check type attribute of blob object."),
			this.isPreviewableSync() ? (b("Second pass: check for magic bytes in file header."), qq.readBlobToHex(a, 0, 4).then(function (a) {
		...
		isPreviewableSync : function () {
			...
			return d && (e = "image/tiff" === c ? qq.supportedFeatures.tiffPreviews : !0),
			!e && b(f + " is not previewable in this browser per the blob's type attr"),
			e
		}
	})
	...
	qq.extend(this, {
		queryServer : function () {
			...
			c.initTransport("sessionRefresh").withParams(a).withCacheBuster().send()
		}
	})
	...
	function g(a) {
		return a && (qq.isString(a) && (a = document.getElementById(a)), a && (c("Attaching to form element."), d(a), i && f(a))),
		a
	}
	var h = this,
	i = a.interceptSubmit,
	...
	qq.extend(this, {
		...
		handleNewFile : function (a, b, c, d, e, f, g, h) {
			...
			qq.each(i.getFileRecords(c, b, a), function (b, c) {
				...
				h = a,
				i = d;
				c.blob instanceof qq.BlobProxy && (h = c.blob, i = -1),
				g = m.addFile({
						uuid : c.uuid,
						name : c.name,
						size : i,
				...
				c.blob instanceof qq.BlobProxy ? j.push(g) : k = g,
				l(g, h),
				e.push({
					id : g,
					file : h
	...
	_getName : function (a, b) {
		...
		g = qq.getExtension(a),
		h = "";
		return b.name && b.name.trim().length && (h = " (" + b.name + ")"),
		c >= 0 ? (f = a.substr(0, c), e !== d && (g = d.split("/")[1]), f += h + "." + g) : f = a + h,
		f
	},
	_getSortedSizes : function (a) {
		"use strict";
		return a = qq.extend([], a),
		a.sort(function (a, b) {
	...
	_generateScaledImage : function (a, b) {
		...
		return d("Attempting to generate scaled version for " + b.name),
		l.generate(b, m, {
			maxSize : e,
			orient : f
		}).then(function () {
			...
			d("Failed attempt to generate scaled version for " + b.name, "error"),
			k.failure(i)
		}),
		k
	},
	_insertExifHeader : function (a, b, c) {
		...
		return d.onload = function () {
			f = d.result,
			e.success(ExifRestorer.restore(f, b))
		},
		d.onerror = function () {
...
qq.TotalProgress = function (a, b) {
	...
	function e(a, b) {
		var c,
		e = a.value;
		void 0 !== e && qq.trimStr(e).length > 0 && (c = d(b), void 0 !== c && (e = e + "." + c), h.onSetName(b, e)),
...
(jQuery), qq.s3 = qq.s3 || {}, qq.s3.util = qq.s3.util || function () {
	...
	return {
		...
		getPolicy : function (a) {
			...
			return b.expiration = qq.s3.util.getPolicyExpirationDate(h),
			c.push({
				acl : f
			}),
			c.push({
			...
			o && (c.push({}), c[c.length - 1][qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE),
			j && (c.push({}), c[c.length - 1][qq.s3.util.SESSION_TOKEN_PARAM_NAME] = j),
			p && (c.push({}), c[c.length - 1][qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE),
			c.push({
				key : e
			}),
			...
			b.conditions = c,
			qq.s3.util.enforceSizeLimits(b, m, n),
			b
		},
		...
		generateAwsParams : function (a, b) {
			...
			c.AWSAccessKeyId = j,
			h && (c["Content-Type"] = h),
			l && (c.success_action_status = l),
			m && (c.success_action_redirect = m),
			n && (c[qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE),
			o && (c[qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE),
			g && (c[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = g),
			c.acl = k,
			...
			b(f).then(function (a, b, d) {
				...
				b && (c.AWSAccessKeyId = b),
				d && (c[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = d),
				e.success(c)
			}, function (a) {
				a = a || "Can't continue further with request to S3 as we did not receive a valid signature and policy from the server.",
				p("Policy signing failed.  " + a, "error"),
				e.failure(a)
			}),
			e
		},
...
(), function () {
	...
	qq.nonTraditionalBasePrivateApi = {
		_onComplete : function (a, b, c, d) {
			...
			q = function (b) {
				delete h._failedSuccessRequestCallbacks[a],
				qq.extend(c, b),
				qq.FineUploaderBasic.prototype._onComplete.apply(h, i),
				n.success(b)
			},
			r = function (f) {
				var g = e;
				qq.extend(c, f),
				c && c.reset && (g = null),
				g ? h._failedSuccessRequestCallbacks[a] = g : delete h._failedSuccessRequestCallbacks[a],
				h._onAutoRetry(a, b, c, d, g) || (qq.FineUploaderBasic.prototype._onComplete.apply(h, i), n.failure(f))
			};
...
(), function () {
	...
	qq.s3.FineUploaderBasic = function (a) {
		...
		qq.extend(b, a, !0),
		this.setCredentials(b.credentials, !0) || (this._currentCredentials.accessKey = b.request.accessKey),
		this._aclStore = this._createStore(b.objectProperties.acl),
		qq.FineUploaderBasic.call(this, b),
	...
	qq.extend(qq.s3.FineUploaderBasic.prototype, {
		...
		setCredentials : function (a, b) {
			if (a && a.secretKey) {
				...
				return this._currentCredentials = qq.extend({}, a),
				qq.isString(a.expiration) && (this._currentCredentials.expiration = new Date(a.expiration)),
				!0
			}
			if (!b)
				...
				onExpired : function () {
					...
					return qq.isGenericPromise(c) ? c.then(function (c) {
						try {
							...
							a.log("Invalid credentials returned from onCredentialsExpired callback! (" + d.message + ")", "error"),
							b.failure("onCredentialsExpired did not return valid credentials.")
						}
					}, function (c) {
						a.log("onCredentialsExpired callback indicated failure! (" + c + ")", "error"),
						b.failure("onCredentialsExpired callback failed.")
					}) : (a.log("onCredentialsExpired callback did not return a promise!", "error"), b.failure("Unexpected return value for onCredentialsExpired.")),
					b
				}
			},
		...
		_determineBucket : function (a) {
			...
			c = new qq.Promise,
			d = this;
			return qq.isFunction(b) ? (b = b(a), qq.isGenericPromise(b) ? c = b : c.success(b)) : qq.isString(b) && c.success(b),
			c.then(function (b) {
				d._buckets[a] = b
			}, function (b) {
		...
		_handleKeynameFunction : function (a, b, c, d) {
			...
			g = function (a) {
				e.log(qq.format("Failed to retrieve key name for {}.  Reason: {}", b, a || "null"), "error"),
				d(a)
			},
			h = a.call(this, b);
		...
		_getEndpointSpecificParams : function (a, b, c) {
			...
			return c && c.getResponseHeader("ETag") ? d.etag = c.getResponseHeader("ETag") : b.etag && (d.etag = b.etag),
			d
		},
		...
		_addCannedFile : function (a) {
			...
			return b = qq.FineUploaderBasic.prototype._addCannedFile.apply(this, arguments),
			this._cannedKeys[b] = a.s3Key,
			this._cannedBuckets[b] = a.s3Bucket,
			b
		}
	})
}
(), qq.s3.RequestSigner = function (a) {
	...
	function b(a, b, c) {
		...
		e && e.invalid ? (c = !0, d = "Invalid policy document or request headers!") : e ? k.expectingPolicy && !e.policy ? (c = !0, d = "Response does not include the base64 encoded policy!") : e.signature || (c = !0, d = "Response does not include the signature!") : (c = !0, d = "Received an empty or invalid response from the server!"),
		c ? (d && k.log(d, "error"), h.failure(d)) : h.success(e)
	}
	function c(a, b, c, d, e, f, g) {
		...
		case i.REQUEST_TYPE.MULTIPART_UPLOAD:
			j = "PUT",
			h = qq.format("partNumber={}&uploadId={}", g, f)
		}
		return h = c + "?" + h,
		qq.each(e, function (a) {
			k.push(a)
		}),
		k.sort(),
		qq.each(k, function (a, b) {
	...
	qq.extend(k, a, !0),
	h = k.signatureSpec.credentialsProvider,
	g = qq.extend(this, new qq.AjaxRequester({
				acceptHeader : "application/json",
				method : k.method,
	...
	qq.extend(this, {
		getSignature : function (a, b) {
			...
			return h.get().secretKey && window.CryptoJS ? h.get().expiration.getTime() > Date.now() ? d(b, e) : h.onExpired().then(function () {
				...
				k.log("Attempt to update expired credentials apparently failed! Unable to sign request.  ", "error"),
				e.failure("Unable to sign request - expired credentials.")
		...
		constructStringToSign : function (a, b, d) {
			...
			return {
				...
				getToSign : function () {
					...
					return j["x-amz-date"] = (new Date).toUTCString(),
					k && (j[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = k),
					i = c(a, b, d, f, j, e, g), {
						headers : function () {
							return f && (j["Content-Type"] = f),
							j
						}
						(),
						endOfUrl : i.endOfUrl,
	...
	function b(a, b, c) {
		...
		delete d[a],
		e.log(qq.format("Received the following response body to an upload success request for id {}: {}", a, h));
		try {
			f = qq.parseJson(h),
			c || f && (f.error || f.success === !1) ? (e.log("Upload success request was rejected by the server.", "error"), g.failure(qq.extend(f, j))) : (e.log("Upload success was acknowledged by the server."), g.success(qq.extend(f, i)))
		} catch (k) {
	...
	qq.extend(this, {
		sendSuccessRequest : function (a, b) {
			var f = new qq.Promise;
			return e.log("Submitting upload success request/notification for " + a),
			c.initTransport(a).withParams(b).send(),
			d[a] = f,
			f
		}
	})
	...
	function b(a) {
		...
		f = new qq.Promise,
		h = g.getKey(a);
		return d["x-amz-acl"] = g.aclStore.get(a),
		g.reducedRedundancy && (d[qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE),
		g.serverSideEncryption && (d[qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE),
		d[qq.s3.util.AWS_PARAM_PREFIX + g.filenameParam] = encodeURIComponent(g.getName(a)),
		qq.each(g.paramsStore.get(a), function (a, b) {
			d[qq.s3.util.AWS_PARAM_PREFIX + a] = encodeURIComponent(b)
		}),
		b = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_INITIATE, c, h).withContentType(g.getContentType(a)).withHeaders(d),
		e.getSignature(a, {
			signatureConstructor : b
		}).then(function (a) {
			d = b.getHeaders(),
			d.Authorization = "AWS " + g.signatureSpec.credentialsProvider.get().accessKey + ":" + a.signature,
			f.success(d, b.getEndOfUrl())
		}, f.failure),
		f
	}
	function c(a, b, c) {
	...
	qq.extend(this, {
		send : function (a) {
			...
			return b(a).then(function (b, e) {
				g.log("Submitting S3 initiate multipart upload request for " + a),
				f[a] = c,
				d.initTransport(a).withPath(e).withHeaders(b).send()
			}, c.failure),
			c
		}
	})
	...
	function b(a, b) {
		...
		return f.getSignature(a, {
			...
			c = g.getHeaders(),
			c.Authorization = "AWS " + h.signatureSpec.credentialsProvider.get().accessKey + ":" + a.signature,
			d.success(c, g.getEndOfUrl())
		}, d.failure),
		d
	}
	function c(a, b, c) {
	...
	qq.extend(this, {
		send : function (a, c, f) {
			...
			return b(a, c).then(function (b, c) {
				var j = d(f);
				h.log("Submitting S3 complete multipart upload request for " + a),
				g[a] = i,
				delete b["Content-Type"],
				e.initTransport(a).withPath(c).withHeaders(b).withPayload(j).send()
			}, i.failure),
			i
		}
	})
	...
	function b(a, b) {
		...
		return e.getSignature(a, {
			...
			c = h.getHeaders(),
			c.Authorization = "AWS " + f.signatureSpec.credentialsProvider.get().accessKey + ":" + a.signature,
			d.success(c, h.getEndOfUrl())
		}, d.failure),
		d
	}
	function c(a, b, c) {
		...
		f.log(qq.format("Abort response status {}, body = {}", b.status, b.responseText)),
		c ? f.log(qq.format("Abort Multipart Upload request for {} failed with status {}.", a, b.status), "error") : h.length ? (c = !0, d = g.getElementsByTagName("Message")[0].textContent, f.log(qq.format("Failed to Abort Multipart Upload request for {}.  Error: {}", a, d), "error")) : f.log(qq.format("Abort MPU request succeeded for file ID {}.", a))
	}
	var d,
	e,
	f = {
	...
	qq.extend(this, {
		send : function (a, c) {
			b(a, c).then(function (b, c) {
				f.log("Submitting S3 Abort multipart upload request for " + a),
				d.initTransport(a).withPath(c).withHeaders(b).send()
			})
		}
	})
	...
	r = {
		...
		initHeaders : function (b, c) {
			...
			return s.restSignature.getSignature(b + "." + c, {
				...
				d = h.getHeaders(),
				d.Authorization = "AWS " + q.get().accessKey + ":" + a.signature,
				g.success(d, h.getEndOfUrl())
			}, g.failure),
			g
		},
		put : function (b, c) {
			...
			return r.initHeaders(b, c).then(function (a, h) {
				var i = f + "/" + h;
				p._registerProgressHandler(b, c, e.size),
				u.track(b, d, c).then(g.success, g.failure),
				d.open("PUT", i, !0),
				qq.each(a, function (a, b) {
					d.setRequestHeader(a, b)
				}),
		...
		setup : function (a) {
			...
			return c ? c instanceof qq.Promise ? c.then(function (a) {
				b.success(a)
					...
					p._getPersistableData(a).uploadId = c,
					d.success(c),
					b.success(c)
				}, function (c) {
					p._getPersistableData(a).uploadId = null,
					b.failure(c),
					d.failure(c)
				})),
			b
	...
	t = {
		...
		send : function (a) {
			...
			c = p._createXhr(a),
			e = p.getFile(a);
			return p._registerProgressHandler(a),
			u.track(a, c).then(b.success, b.failure),
			t.setup(a, c, e).then(function (b) {
				d("Sending upload request for " + a),
				c.send(b)
			}, b.failure),
			b
		},
	...
	u = {
		...
		key : {
			promise : function (a) {
				...
				return null == d ? (p._setThirdPartyFileId(a, b), g(a, c(a)).then(function (c) {
						p._setThirdPartyFileId(a, c),
						b.success(c)
					}, function (c) {
						p._setThirdPartyFileId(a, null),
						b.failure(c)
					})) : qq.isGenericPromise(d) ? d.then(b.success, b.failure) : b.success(d),
				b
			},
			urlSafe : function (a) {
		...
		response : {
			parse : function (a, b) {
				...
				f = {};
				try {
					d(qq.format("Received response status {} with body: {}", b.status, b.responseText)),
					b.status === e ? f.success = !0 : (c = u.response.parseError(b.responseText), c && (f.error = c.message, f.code = c.code))
				} catch (g) {
	...
	qq.override(this, function (a) {
		return {
			expunge : function (b) {
				...
				void 0 !== c && d && s.abortMultipart.send(b, c),
				a.expunge(b)
			},
	...
	function c(b, c) {
		...
		try {
			if (d = c.contentDocument || c.contentWindow.document, e = d.body.innerHTML, f = qq.s3.util.parseIframeResponse(c), f.bucket === i && f.key === qq.s3.util.encodeQueryStringParam(h.getThirdPartyFileId(b)))
				return !0;
	...
	function f(a) {
		...
		return e(a, b).then(function (e) {
			e.appendChild(d),
			h._attachLoadEvent(b, function (d) {
				l("iframe loaded"),
				d ? d.success === !1 && (l("Amazon likely rejected the upload request", "error"), f.failure(d)) : (d = {}, d.success = c(a, b), d.success === !1 ? (l("A success response was received by Amazon, but it was invalid in some way.", "error"), f.failure(d)) : (qq.extend(d, qq.s3.util.parseIframeResponse(b)), f.success(d))),
				g(a, b)
			}),
			l("Sending upload request for " + a),
			e.submit(),
			qq(e).remove()
		}, f.failure),
		f
	...
	qq.extend(this, {
		uploadFile : function (a) {
			...
			return h.getThirdPartyFileId(a) ? h._getFileState(a).bucket ? f(a).then(c.success, c.failure) : m(a).then(function (b) {
				h._getFileState(a).bucket = b,
				f(a).then(c.success, c.failure)
			}) : n(a, b).then(function (b) {
				m(a).then(function (d) {
					h._getFileState(a).bucket = d,
					h._setThirdPartyFileId(a, b),
					f(a).then(c.success, c.failure)
				}, function (a) {
					c.failure({
						error : a
	...
	qq.s3.FineUploader = function (a) {
		...
		qq.extend(b, a, !0),
		qq.FineUploader.call(this, b, "s3"),
		qq.supportedFeatures.ajaxUploading || void 0 !== b.iframeSupport.localBlankPagePath || (this._options.element.innerHTML = "<div>You MUST set the <code>localBlankPagePath</code> property of the <code>iframeSupport</code> option since this browser does not support the File API!</div>")
	},
...
(), function (a) {
	...
	a.fn.fineUploaderS3 = function (b) {
		return "object" == typeof b && (b.endpointType = "s3"),
		a.fn.fineUploader.apply(this, arguments)
	}
}
(jQuery), qq.azure = qq.azure || {}, qq.azure.util = qq.azure.util || function () {
	...
	return {
		...
		parseAzureError : function (a, b) {
			...
			g ? (d = g.getElementsByTagName("Message")[0], d && (h.message = d.textContent), c = g.getElementsByTagName("Code")[0], c && (h.code = c.textContent), b("Parsed Azure error: " + JSON.stringify(h), "error"), h) : void 0
		}
	}
}
(), function () {
	...
	qq.extend(qq.azure.FineUploaderBasic.prototype, {
		...
		_addCannedFile : function (a) {
			...
			return b = qq.FineUploaderBasic.prototype._addCannedFile.apply(this, arguments),
			this._cannedBlobNames[b] = a.blobName,
			b
		},
		_deleteBlob : function (a, b) {
			...
			i = new qq.azure.DeleteBlob({
					...
					onDelete : function (a) {
						c._onDelete(a),
						c._options.callbacks.onDelete(a)
					},
					onDeleteComplete : function (b, e, f) {
						delete d[b],
						f && (a ? c.log("Will cancel upload, but failed to remove uncommitted parts from Azure.", "error") : qq.azure.util.parseAzureError(e.responseText, qq.bind(c.log, c))),
						a ? (qq.FineUploaderBasic.prototype._onCancel.call(c, b, c.getName(b)), c.log("Deleted uncommitted blob chunks for " + b)) : (c._onDeleteComplete(b, e, f), c._options.callbacks.onDeleteComplete(b, e, f))
					}
				}),
...
(), qq.azure.XhrUploadHandler = function (a, b) {
	...
	function c(a) {
		...
		return e(a).then(function (c) {
			...
			t.putBlockList.send(a, c, e, d, function (b) {
				...
				h("Success combining chunks for id " + a),
				b.success({}, c)
			}, function (c) {
				h("Attempt to combine chunks failed for id " + a, "error"),
				f(c, b)
			})
		}, b.failure),
		b
	...
	function e(a, b) {
		...
		e = new qq.Promise,
		f = function (a) {
			h("GET SAS request succeeded."),
			e.success(a)
		},
		g = function (a, b) {
			h("GET SAS request failed: " + a, "error"),
			e.failure({
		...
		j = function (b) {
			h(qq.format("Failed to determine blob name for ID {} - {}", a, b), "error"),
			e.failure({
				error : b
			})
		};
	...
	qq.extend(this, {
		uploadChunk : function (a, b) {
			...
			return e(a, b).then(function (d) {
				...
				g._registerProgressHandler(a, b, i.size),
				g._registerXhr(a, b, e, t.putBlock),
				t.putBlock.upload(a + "." + b, e, d, b, i.blob).then(function (b) {
					g._getPersistableData(a).blockIdEntries || (g._getPersistableData(a).blockIdEntries = []),
					g._getPersistableData(a).blockIdEntries.push(b),
					h("Put Block call succeeded for " + a),
					c.success({}, e)
				}, function () {
					h(qq.format("Put Block call failed for ID {} on part {}", a, b), "error"),
					f(e, c)
				})
			}, c.failure),
			c
		...
		uploadFile : function (a) {
			...
			return e(a).then(function (d) {
				...
				g._registerProgressHandler(a),
				t.putBlob.upload(a, e, d, c).then(function () {
					h("Put Blob call succeeded for " + a),
					b.success({}, e)
				}, function () {
					h("Put Blob call failed for " + a, "error"),
					f(e, b)
				})
			}, b.failure),
			b
	...
	function b(a, b, c) {
		var d = e[a];
		c ? d.failure("Received response code " + b.status, b) : b.responseText.length ? d.success(b.responseText) : d.failure("Empty response.", b),
		delete e[a]
	}
	var c,
	d = {
	...
	qq.extend(this, {
		request : function (a, b) {
			var f = new qq.Promise,
			g = d.restRequestVerb;
			return d.log(qq.format("Submitting GET SAS request for a {} REST request related to file ID {}.", g, a)),
			e[a] = f,
			c.initTransport(a).withParams({
				bloburi : b,
				_method : g
	...
	qq.extend(this, {
		method : c,
		send : function (a) {
			return d.log("Submitting Delete Blob request for " + a),
			b.initTransport(a).send()
		}
	})
	...
	qq.extend(this, {
		...
		upload : function (a, c, g, h) {
			var i = new qq.Promise;
			return d.log("Submitting Put Blob request for " + a),
			f[a] = i,
			e[a] = g,
			b.initTransport(a).withPayload(h).withHeaders({
				"Content-Type" : h.type
			}).send(c),
			i
		}
	...
	qq.extend(this, {
		...
		send : function (a, d, h, i, j) {
			...
			m = b(h);
			return e[a] = l,
			f.log(qq.format("Submitting Put Block List request for {}", a)),
			g[a] = qq.format("{}&comp=blocklist", d),
			k = c.initTransport(a).withPayload(m).withHeaders({
	...
	qq.extend(this, {
		...
		upload : function (a, d, i, j, k) {
			...
			m = b(j);
			return f[a] = l,
			g.log(qq.format("Submitting Put Block request for {} = part {}", a, j)),
			h[a] = qq.format("{}&comp=block&blockid={}", i, encodeURIComponent(m)),
			e[a] = {
				part : j,
				id : m
			},
			c.initTransport(a).withPayload(k).send(d),
			l
		}
	})
}, function () {
	...
	qq.azure.FineUploader = function (a) {
		...
		qq.extend(b, a, !0),
		qq.FineUploader.call(this, b, "azure")
	},
...
(), function (a) {
	...
	a.fn.fineUploaderAzure = function (b) {
		return "object" == typeof b && (b.endpointType = "azure"),
		a.fn.fineUploader.apply(this, arguments)
	}
}
(jQuery);
...
(), function () {
	...
	g = e.SHA1 = d.extend({
			...
			_doProcessBlock : function (a, b) {
				for (var c = this._hash.words, d = c[0], e = c[1], g = c[2], h = c[3], i = c[4], j = 0; 80 > j; j++) {
					...
					l += 20 > j ? (e & g | ~e & h) + 1518500249 : 40 > j ? (e^g^h) + 1859775393 : 60 > j ? (e & g | e & h | g & h) - 1894007588 : (e^g^h) - 899497514,
					i = h,
					h = g,
					g = e << 30 | e >>> 2,
					e = d,
	...
	a.SHA1 = d._createHelper(g),
	a.HmacSHA1 = d._createHmacHelper(g)
}
();
/*! 2015-06-04 */
