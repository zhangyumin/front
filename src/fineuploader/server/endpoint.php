...
$uploader->sizeLimit = 200 * 1024 * 1024; // default is 10 MiB
...
if ($method == "POST") {
    ...
    if (isset($_POST["generateError"])) {
        ...
        $result = $uploader->combineChunks("/var/www/front/data/");
    }
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("/var/www/front/data/");
    ...
    $result = $uploader->handleDelete("/var/www/front/data/");
    echo json_encode($result);
}
else {
