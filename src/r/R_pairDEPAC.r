##########################################################################################
#2015/4/15
#DEXSeq 分析 DE PAC (运行速度比较慢，比DE gene慢很多)
...
#输出：
#t_ae_pacsd24n_flt.APAgene.pac -- 在APAgene下的PAC文件
#t_ae_pacsd24n_flt.APAgene.pac.LeafXseed24H.minpat0_minrep0_norm0 -- 两两样本的DE结果

#注意：算rice的42tissues，共91种pairwise，要算约5小时。每次算3分钟左右。（可能DEX的estimateDisper特别慢）
