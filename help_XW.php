	...
	<div class="main">
                    <div class="page_container">
                       <div class="jumpto-block">
                        ...
                        <p>PlantAPA is a web server for query, visualization, and analysis of poly(A) sites in plants, which can profile heterogeneous cleavage sites and quantify expression pattern of poly(A) sites across different conditions. To date, PlantAPA provides the largest database of APA in plants, including rice, Arabidopsis, <i>Medicago truncatula</i>, and <i>Chlamydomonas reinhardtii</i> (see <a href="./index.php">datasets</a>).</p>
                        <p id="download">Users can download PATs, PACs, and relevent sequences from the <a href="./download.php">download</a> page.<span style="background-color:yellow;">(将download页面的？链接到这里）</span></p>
                      </div>
                    </div>
        </div>
        </div>
<p><img src="doc/download dataset.png" width="1132" height="727" border="0" alt="download dataset.png"></p>
<p align="center"><font color="#003333">Datasets for downloading in PlantAPA</font></p>
<div class="ym-wrapper">
	<div class="main">
                    <div class="page_container">
                      <div class="jumpto-block">
                        ...
                        <p id="trapstep1">
                            In the <span style="background-color:yellow;">PAC 
                trap</span> module, users can upload two kinds of sequences, short reads and ESTs. You can also click “Try an example” button to load the demo data. In addition, you can upload a file to specific coordinates of poly(A) sites. Also, the supported species are listed in the drop-down box.
                        </p>
                        <div class="picdiv">
                            <img class="pic" src="./pic/help/species.png" />
                            <br>Panel of choosing species and file types</div>
                        <!--<p>2) Input-->
                        <p id="trapstep2">
                        ...
                        <p>
                        PlantAPA allows users to upload more than one files, each file can be assigned two labels, one denoting the respective sample (ex. leaf_replicate1), the other denoting its group. 
                Assigning each file with sample or group label is useful in the analysis of APA, for example, detecting DE genes or PACs, and is also useful in visualizing poly(A) sites from individual groups in our graphic module. 
                        </p>
                        <div class="picdiv">
                        ...
                        <p>
                        The second one serves for users to paste sequencs in the textbox if they do not prepare a file.  It 
                is of note that only one sample can be input if this way is 
                used. </p>
                        <div class="picdiv">
                            <img class="pic" src="./pic/help/text.bmp" />
                            <br>Inputting sequences in&nbsp;a textbox</div>
                        <!--<p>3) Options for mapping reads (optional)-->
                                                <p>
Users can also&nbsp;provide the poly(A) site file directly. In this way,&nbsp;PlantAPA will skip the extraction pipeline and load the input sites to a user database directly.
                        Then users can browse,&nbsp;visualize, and analyze&nbsp;their 
                own poly(A) sites through the PAC browse module,&nbsp;PAC viewer 
                module, and PAC analysis module&nbsp;in PlantAPA.</p>
                      </div>
                    </div>
        </div>
        </div>
<p><span style="background-color:yellow;">这里截一个polyA site输入的点try example后的截图，显示PA文件的格式。</span></p>
<div class="ym-wrapper">
	<div class="main">
                    <div class="page_container">
                      <div class="jumpto-block">
                        <div class="picdiv">
                            Inputting poly(A) sites, each line is Chr, Strand, 
                    Coordinate, Number of PATs</div>
<p id="trapstep3">
                        ...
                        <p>
                        Each time, when a user visits PlantAPA to conduct a poly(A) site extraction, an unique task ID will be assigned. In our server, a folder in the same name as this project name will be created to hold all relevant data for the poly(A) site extraction. The user can further obtain all results of this task by searching the task ID in the “<span style="background-color:yellow;">My task</span>” page.
                        </p>
                        <div class="picdiv">
                        ...
                        <p>
                        All tasks started from the same IP address are also listed in the “<span style="background-color:yellow;">My task</span>” page for the user to retrieve at any time.
                        </p>
                        <div class="picdiv">
                        ...
                        <div class="picdiv">
                            ...
                            <br>Downloading results of a PAC trap 
                        task</div>
                        <p>
                        Also, additional information, such as mapping summary, single nucleotide compositions around PACs, top hexamers upstream of PACs, will be displayed in the <span style="background-color:yellow;">result page</span> to facilitate users to evaluate their own data.
                        </p>
                        <div class="picdiv">
                            <img class="pic" src="./pic/help/result.bmp" />
                            <br>Result page of a PAC trap task
                        (Click <span style="background-color:yellow;">here</span> 
                    to view an example)</div>
                        <p>
                        ...
                        <p>The <span style="background-color:yellow;">PAC search</span> module allows users to query genes or PACs in the data sets of interest by a variety of keywords, such as gene ID, chromosome fragment, gene functions, GO term, and GO ID. 
                Batch search is supported, where lists of Gene IDs, GO terms, or GO IDs can be provided as query input.
                        </p>
                        <div class="picdiv">
                    ...
                    to view an example)</div>
                        ...
                        <p>Users can have a quick access to the PAC browser by clicking the “P<span style="background-color:yellow;">AC browse</span>” tab in the main menu or the “View” link in a PAC list.
                        </p>
                        <div class="picdiv">
                        ...
                        <p>
                        One or more data sets from each plant species can be quickly loaded and graphically browsed online, by selecting the checkboxes of data sets in the ‘Available 
                Tracks’ panel. Users can conduct a search with a gene or chromosome fragment to zoom in on particular PAC regions. Data tracks of PACs from different cells, tissues or conditions can be displayed in sync with tracks of PATs, offering a more intuitive way to explore and compare the usage of PACs among different samples.
                        ...
                        <div class="picdiv">
                            ...
                            <br>Right-click context menu on a gene model or 
                    PAC&nbsp;
<!--                            <br><br>
                        ...
                        <p>
                        Another graph presents both the original and the modified versions of the gene model and the distributions of PACs/PATs across different samples in a more intuitive way, where users can inspect the locations, expression patterns, and differential usage of PACs in a gene, especially the selection of heterogeneous cleavage sites.<span style="font-size:12pt;"> </span><span lang=EN-US style="font-size:12pt; mso-bidi-font-size:
11.0pt;mso-fareast-font-family:宋体;
mso-fareast-theme-font:minor-fareast;mso-bidi-theme-font:minor-bidi;mso-ansi-language:
EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">Cleavage sites of a
PAC are depicted in vertical lines with height representing the number of
supporting PATs. The dominant cleavage site supported by the maximum number of
PATs in a PAC is marked by a thick line. If the number of PATs of the dominant
cleavage site exceeds the maximum scale value (default of 50) of the vertical
axis, a small horizontal line will be shown on the top of the thick line. A
text label is found under each dominant cleavage site to clearly indicate the
expression level, i.e., total number of supporting PATs, of the respective PAC.Users can also view
selected samples by choosing specific samples in the ‘Individual’ drop-down
list or group replicates within each individual sample by clicking the ‘Grouping’
drop-down list. </span></p>
                        <div class="picdiv">
                            <img class="pic" src="./pic/help/pat_distribution.png" />
                            <br><span lang=EN-US style='font-size:12.0pt;mso-bidi-font-size:
11.0pt;font-family:"Times New Roman","serif";mso-fareast-font-family:宋体;
mso-fareast-theme-font:minor-fareast;mso-bidi-theme-font:minor-bidi;mso-ansi-language:
EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA'><font face="Arial">Graph presents both
the gene model and the distributions of PACs/PATs across different samples</font></span></div>
                        <p>
                        An additional bar chart<font face="Arial"><span style="font-size:12pt;"> 
                </span></font><span lang=EN-US style='font-size:12.0pt;mso-bidi-font-size:
11.0pt;font-family:"Times New Roman","serif";mso-fareast-font-family:宋体;
mso-fareast-theme-font:minor-fareast;mso-bidi-theme-font:minor-bidi;mso-ansi-language:
EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA'><font face="Arial">is presented to
profile the usage quantification of all PACs of the queried gene across
different samples, providing a simple and direct way to compare the usage of
PACs and determine ubiquitous or sample-specific PACs. By default, the bar
chart displays the number of PATs of all samples. By checking the “Ratio” box,
users can compare the usage of PACs within each sample to avoid great disparity
in PAT number among samples. 
                        </font></span></p>
                        <div class="picdiv">
                            <br><img class="pic" src="./pic/help/pac_usage.bmp" />
                            <br>Bar chart profiles the usage quantification 
                    of all PACs in a gene
                        </div>
                        <!--<h3>6.2. Gene sequence viewer</h3>-->
                        <p>PlantAPA provides the gene sequence annotated with exon-intron structure and 3’ UTR, poly(A) signals and positions. <span lang=EN-US style='font-size:12.0pt;mso-bidi-font-size:
11.0pt;font-family:"Times New Roman","serif";mso-fareast-font-family:宋体;
mso-fareast-theme-font:minor-fareast;mso-bidi-theme-font:minor-bidi;mso-ansi-language:
EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA'><font face="Arial">By default the most
dominant poly(A) signal, AATAAA, and its 1 nt variants are scanned to obtain
poly(A) signals. Users can also specify additional patterns to locate possible
poly(A) signals. Users can set a region around poly(A) sites to narrow the
scope of poly(A) signal search by dragging the slider. Further, users can
choose to highlight genic regions, e.g., intron, exon, or 3’UTR, cleavage sites,
and poly(A) signals in different styles or colors in the corresponding
sequence, facilitating manual inspection of the sequence of poly(A) sites in
different genic locations. Particularly, heterogeneous cleavage sites of each
PAC are in pink background, and the most dominant cleavage site in each PAC is denoted
in red and highlighted in yellow.</font></span> 
                        </p>
                        <div class="picdiv">
...
11.0pt;font-family:"Times New Roman","serif";mso-fareast-font-family:宋体;
mso-fareast-theme-font:minor-fareast;mso-bidi-theme-font:minor-bidi;mso-ansi-language:
EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA'><font face="Arial">Gene sequence annotated with gene model, poly(A)
signals, and cleavage sites</font></span><font face="Arial">
                        </font></div>
                        <h2>7. <span>PAC analysis</span>: analysis of APA switching between two conditions</h2>
                        <p id="analysishelp1">Following the “<span style="background-color:yellow;">PAC analysis</span>” tab in the main menu, users can choose to generate lists of differentially expressed genes, PACs with differential usage, genes with 3’ UTR lengthening or shortening, and APA-site switching genes, using the user uploaded PACs together with PlantAPA stored PACs.
                        </p>
                        <div class="picdiv">
                            <img class="pic" src="./pic/help/analysispic.png" />
                            <br>Schema of four functions in the PAC analysis module
                        </div>
                        <p>
...
<p>Before analyzing PACs between two samples,&nbsp;users can filter PACs or 
genes by various combination of filtering conditions.<br>
                            </p>
<p><img class="pic" src="./pic/help/analysis_additional_option.png" />
                            <br><font color="gray">Additional options for PAC 
analysis</font></p>
<div class="ym-wrapper">
	<div class="main">
                    <div class="page_container">
                    <div class="jumpto-block">
                        ...
                        <div class="picdiv">
                            ...
                            <br>Result page of 'DE Gene' function (Click <span style="background-color:yellow;">here</span> 
                    for an example)</div>
                        ...
                        <div class="picdiv">
                            ...
                            <br>Result page of 'DE PAC' function
                        (Click <span style="background-color:yellow;">here</span> 
                    for an example)</div>
                        ...
                        <div class="picdiv">
                            ...
                            <br>Result page  of '3'UTR Lengthening' function
(Click <span style="background-color:yellow;">here</span> for an example)                        </div>
                        ...
                        <div class="picdiv">
                            ...
                            <br>Result page  of 'APA Switching' function
                        (Click <span style="background-color:yellow;">here</span> 
                    for an example)</div>
                    </div>
                    </div>
