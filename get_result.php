...
//                echo"<pre>$out10</pre>";
            ...
            foreach ($upload_name as $key => $value) {
                 ...
                 shell_exec("./src/c/bedGraphToBigWig ../jbrowse/data/".$_SESSION['file']."/$value.positive.sorted.uniq.bedGraph ./src/".$_SESSION['file'].".sizes ../jbrowse/data/".$_SESSION['file']."/$value.UsrPosPA.bw");
                 shell_exec("./src/c/bedGraphToBigWig ../jbrowse/data/".$_SESSION['file']."/$value.negative.sorted.uniq.bedGraph ./src/".$_SESSION['file'].".sizes ../jbrowse/data/".$_SESSION['file']."/$value.UsrNegPA.bw");
