...
//                $_SESSION['distance']=$_POST['distance'];
            if($_POST['sequence_text']!=''){
                ...
                $textfile=$_POST['text_name'].".fa";
                file_put_contents($filepath.$textfile, $_POST['sequence_text']);
                $usr_group = array();
                array_push($usr_group, $_POST['text_group']);
...
//                echo"<pre>$out10</pre>";
            ...
            foreach ($upload_name as $key => $value) {
                 ...
                 shell_exec("./src/c/jq '(.tracks) |= . + [{\"storeClass\" : \"JBrowse/Store/SeqFeature/BigWig\",\"urlTemplate\" : \"'$value'.UsrPosPA.bw\",\"type\" : \"JBrowse/View/Track/Wiggle/XYPlot\",\"label\" : \"'$value' PAT  plus strand\",\"category\": \"trap results\",\"key\" : \"'$value' PAT  plus strand\",\"autoscale\" : \"local\",\"style\" : {\"neg_color\" : \"red\",\"pos_color\" : \"blue\"},\"variance_ban\" : false}]' /var/www/jbrowse/data/".$_SESSION['file']."/trackList.json > /var/www/jbrowse/data/".$_SESSION['file']."/trackList1.json");
                 shell_exec("./src/c/jq '(.tracks) |= . + [{\"storeClass\" : \"JBrowse/Store/SeqFeature/BigWig\",\"urlTemplate\" : \"'$value'.UsrNegPA.bw\",\"type\" : \"JBrowse/View/Track/Wiggle/XYPlot\",\"label\" : \"'$value' PAT minus strand\",\"category\": \"trap results\",\"key\" : \"'$value' PAT minus strand\",\"autoscale\" : \"local\",\"style\" : {\"neg_color\" : \"blue\",\"pos_color\" : \"red\"},\"variance_ban\" : false}]' /var/www/jbrowse/data/".$_SESSION['file']."/trackList1.json > /var/www/jbrowse/data/".$_SESSION['file']."/trackList2.json");
