...
//            var_dump($_SESSION['analysis']);
    ...
    //                    alert(params);
        ...
        function update_page1(json) { //回传函数实体，参数为XMLhttpRequest.responseText  
                window.location.href='aftertreatment_result.php?result=degene&species='+json.species;
//            alert("successful");
        }
        function update_page2(json) { //回传函数实体，参数为XMLhttpRequest.responseText  
            window.location.href='aftertreatment_result.php?result=depac&species='+json.species;
//            alert("successful");
        }
        function update_page3(json) { //回传函数实体，参数为XMLhttpRequest.responseText  
            window.location.href='aftertreatment_result.php?result=switchinggene_o&species='+json.species;
//            alert("successful");
        }
        function update_page4(json) { //回传函数实体，参数为XMLhttpRequest.responseText  
            window.location.href='aftertreatment_result.php?result=switchinggene_n&species='+json.species;
//            alert("successful");
        }
        function loading(){
            $('#mainpage').hide();
           ...
           <div class="box info ym-form">
            ...
            <div class="info">   
                <div class="step-title flip" onclick="chgArrow()">
                    <a href="./help.php#analysishelp1" target="_blank"><img src="./pic/help.png" title="tip" style="width:20px;height: 20px;display: inline-block"></a>
                                                        ...
                                                        <div id="sample1" style="width:65%;margin:auto;">
                                                            <label for="all1">Sample 1</label><br>
                                                                <?php
                                                                    ...
                                                                    //arab
                                                                    $i=1;
                                                                    $mysql_arab=mysql_query("select distinct PA_col,label from t_sample_desc where species='arab';");
                                                                    echo "<div id='arab1'>";
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene1' id=a1$i name=sample1[] value=$arab_row[0] onclick=\"ClickOption(this,'b1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    ...
                                                                    if($_SESSION['species']=='arab'){
                                                                        ...
                                                                        foreach ($_SESSION['file_real'] as $key => $value) {
                                                                            echo "<input type=\"checkbox\" class='degene1' name=sample1[] id=asys1$j value=$value onclick=\"ClickOption(this,'asys2$j')\"><span class='usrdata'>$value</span><br>";
                                                                            $j++;
                                                                        }
                                                                    }
                                                                    echo "</div>";
                                                                    //japonica
                                                                    $i=1;
                                                                    $mysql_japonica=mysql_query("select distinct PA_col,label from t_sample_desc where species='japonica';");
                                                                    echo "<div id='japonica1' style='display:none'>";
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene1' id=a2$i name=sample1[] value=$japonica_row[0] onclick=\"ClickOption(this,'b2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    ...
                                                                    //mtr
                                                                    $i=1;
                                                                    $mysql_mtr=mysql_query("select distinct PA_col,label from t_sample_desc where species='mtr';");
                                                                    echo "<div id='mtr1' style='display:none'>";
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene1' id=a3$i name=sample1[] value=$mtr_row[0] onclick=\"ClickOption(this,'b3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    ...
                                                                    //chlamy
                                                                    $i=1;
                                                                    $mysql_chlamy=mysql_query("select distinct PA_col,label from t_sample_desc where species='chlamy';");
                                                                    echo "<div id='chlamy1' style='display:none'>";
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene1' id=a4$i name=sample1[] value=$chlamy_row[0] onclick=\"ClickOption(this,'b4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                        ...
                                                        <div id="sample2" style="width:65%;margin:auto;">
                                                            <label for="all2">Sample 2</label><br>
                                                                <?php
                                                                    ...
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene2' id=b1$i name=sample2[] value=$arab_row[0] onclick=\"ClickOption(this,'a1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='arab'){
                                                                        $j=1;
                                                                        foreach ($_SESSION['file_real'] as $key => $value) {
                                                                            echo "<input type=\"checkbox\" class='degene2' name=sample2[] id=asys2$j value=$value onclick=\"ClickOption(this,'asys1$j')\"><span class='usrdata'>$value</span><br>";
                                                                            $j++;
                                                                        }
                                                                    }
                                                                    echo "</div>";
                                                                    ...
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene2' id=b2$i name=sample2[] value=$japonica_row[0] onclick=\"ClickOption(this,'a2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='japonica'){
                                                                        $j=1;
                                                                    ...
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene2' id=b3$i name=sample2[] value=$mtr_row[0] onclick=\"ClickOption(this,'a3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='mtr'){
                                                                        $j=1;
                                                                    ...
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='degene2' id=b4$i name=sample2[] value=$chlamy_row[0] onclick=\"ClickOption(this,'a4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='chlamy'){
                                                                        $j=1;
                                                        ...
                                                        <div id="sample3" style="width:65%;margin:auto;">
                                                            <label for="all1">Sample 1</label><br>
                                                                <?php
                                                                    ...
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac1' id=c1$i name=sample1[] value=$arab_row[0] onclick=\"ClickOption(this,'d1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    unset($sys_sample);
                                                                    if($_SESSION['species']=='arab'){
                                                                    ...
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac1' id=c2$i name=sample1[] value=$japonica_row[0] onclick=\"ClickOption(this,'d2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='japonica'){
                                                                        $j=1;
                                                                    ...
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac1' id=c3$i name=sample1[] value=$mtr_row[0] onclick=\"ClickOption(this,'d3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='mtr'){
                                                                        $j=1;
                                                                    ...
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac1' id=c4$i name=sample1[] value=$chlamy_row[0] onclick=\"ClickOption(this,'d4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='chlamy'){
                                                                        $j=1;
                                                        ...
                                                        <div id="sample4" style="width:65%;margin:auto;">
                                                            <label for="all2">Sample 2</label><br>
                                                                <?php
                                                                    ...
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac2' id=d1$i name=sample2[] value=$arab_row[0] onclick=\"ClickOption(this,'c1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='arab'){
                                                                        $j=1;
                                                                    ...
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac2' id=d2$i name=sample2[] value=$japonica_row[0] onclick=\"ClickOption(this,'c2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='japonica'){
                                                                        $j=1;
                                                                    ...
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac2' id=d3$i name=sample2[] value=$mtr_row[0] onclick=\"ClickOption(this,'c3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='mtr'){
                                                                        $j=1;
                                                                    ...
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='depac2' id=d4$i name=sample2[] value=$chlamy_row[0] onclick=\"ClickOption(this,'c4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='chlamy'){
                                                                        $j=1;
                                                            ...
                                                            <div id="sample5" style="width:65%;margin:auto;">
                                                                <label for="all1">Sample 1</label><br>
                                                                    ...
                                                                    $sys_sample=array();
                                                                        ...
                                                                        while($arab_row= mysql_fetch_row($mysql_arab))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr1' id=e1$i name=sample1[] value=$arab_row[0] onclick=\"ClickOption(this,'f1$i')\">$arab_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='arab'){
                                                                            $j=1;
                                                                        ...
                                                                        while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr1' id=e2$i name=sample1[] value=$japonica_row[0] onclick=\"ClickOption(this,'f2$i')\">$japonica_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='japonica'){
                                                                            $j=1;
                                                                        ...
                                                                        while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr1' id=e3$i name=sample1[] value=$mtr_row[0] onclick=\"ClickOption(this,'f3$i')\">$mtr_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='mtr'){
                                                                            $j=1;
                                                                        ...
                                                                        while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr1' id=e4$i name=sample1[] value=$chlamy_row[0] onclick=\"ClickOption(this,'f4$i')\">$chlamy_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='chlamy'){
                                                                            $j=1;
                                                            ...
                                                            <div id="sample6" style="width:65%;margin:auto;">
                                                                <label for="all2">Sample 2</label><br>
                                                                    <?php
                                                                        ...
                                                                        while($arab_row= mysql_fetch_row($mysql_arab))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr2' id=f1$i name=sample2[] value=$arab_row[0] onclick=\"ClickOption(this,'e1$i')\">$arab_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='arab'){
                                                                            $j=1;
                                                                        ...
                                                                        while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr2' id=f2$i name=sample2[] value=$japonica_row[0] onclick=\"ClickOption(this,'e2$i')\">$japonica_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='japonica'){
                                                                            $j=1;
                                                                        ...
                                                                        while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr2' id=f3$i name=sample2[] value=$mtr_row[0] onclick=\"ClickOption(this,'e3$i')\">$mtr_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='mtr'){
                                                                            $j=1;
                                                                        ...
                                                                        while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                        {
                                                                            echo "<input type=\"checkbox\" class='only3utr2' id=f4$i name=sample2[] value=$chlamy_row[0] onclick=\"ClickOption(this,'e4$i')\">$chlamy_row[1]<br>";
                                                                            $i++;
                                                                        }
                                                                        if($_SESSION['species']=='chlamy'){
                                                                            $j=1;
                                                        ...
                                                        <div id="sample7" style="width:65%;margin:auto;">
                                                            <label for="all1">Sample 1</label><br>
                                                                ...
                                                                $sys_sample=array();
                                                                    ...
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr1' id=g1$i name=sample1[] value=$arab_row[0] onclick=\"ClickOption(this,'h1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='arab'){
                                                                        $j=1;
                                                                    ...
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr1' id=g2$i name=sample1[] value=$japonica_row[0] onclick=\"ClickOption(this,'h2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='japonica'){
                                                                        $j=1;
                                                                    ...
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr1' id=g3$i name=sample1[] value=$mtr_row[0] onclick=\"ClickOption(this,'h3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='mtr'){
                                                                        $j=1;
                                                                    ...
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr1' id=g4$i name=sample1[] value=$chlamy_row[0] onclick=\"ClickOption(this,'h4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='chlamy'){
                                                                        $j=1;
                                                        ...
                                                        <div id="sample8" style="width:65%;margin:auto;">
                                                            <label for="all2">Sample 2</label><br>
                                                                <?php
                                                                    ...
                                                                    while($arab_row= mysql_fetch_row($mysql_arab))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr2' id=h1$i name=sample2[] value=$arab_row[0] onclick=\"ClickOption(this,'g1$i')\">$arab_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='arab'){
                                                                        $j=1;
                                                                    ...
                                                                    while($japonica_row= mysql_fetch_row($mysql_japonica))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr2' id=h2$i name=sample2[] value=$japonica_row[0] onclick=\"ClickOption(this,'g2$i')\">$japonica_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='japonica'){
                                                                        $j=1;
                                                                    ...
                                                                    while($mtr_row= mysql_fetch_row($mysql_mtr))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr2' id=h3$i name=sample2[] value=$mtr_row[0] onclick=\"ClickOption(this,'g3$i')\">$mtr_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='mtr'){
                                                                        $j=1;
                                                                    ...
                                                                    while($chlamy_row= mysql_fetch_row($mysql_chlamy))
                                                                    {
                                                                        echo "<input type=\"checkbox\" class='none3utr2' id=h4$i name=sample2[] value=$chlamy_row[0] onclick=\"ClickOption(this,'g4$i')\">$chlamy_row[1]<br>";
                                                                        $i++;
                                                                    }
                                                                    if($_SESSION['species']=='chlamy'){
                                                                        $j=1;
